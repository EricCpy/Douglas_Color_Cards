...
As we can see, there is a significant evidence, that the mean \( \Delta \)E varies across different card positions (targets). The following graphic visualizes this.
