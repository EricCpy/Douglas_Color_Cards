...
CIELA found use in many applications - it is used when a conversion between color spaces are needed or when you want to define a palette to be the same across many devices.
