...
1. Color difference of mean over all cards to master target: is it in some uncertainty area? (Eric Jonas: R-Code ✔)
1. Are some Lab values more often in master than in mean? (Eric Jonas: R-Code ✔)
1. How close are CMYK and Lab values? (Eric Jonas: R-Code ✔)
