...
This section explores the influence of channels on \( \Delta \)E. For the following scatter plots we chose to exclude field 18 because its \( \Delta \)E value significantly deviates from the other fields, which would disproportionately influence the results.
...
**One can visualize this with classical box plots or alternatively with the fancier violin plots. From box plots one would conclude to prefer a 2nd order interaction model ...**
