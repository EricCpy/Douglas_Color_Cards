...
```{r violinPolygonGradientQuartilesVSboxplots, echo=FALSE, fig.width=8, fig.height=8, cache=!full_refit, fig.cap="Violin plots with quartile regeion filled compared with box plots", fig.align='center'}
ggpubr::ggarrange(
  violin_final, b2,
  ncol = 2, nrow = 1,
  common.legend = TRUE,
