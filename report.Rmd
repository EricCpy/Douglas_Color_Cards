...
quantiles <- df_input %>% group_by(as.character(formula), method) %>% summarise(q25 = quantile(value, .25), q75 = quantile(value, .75))
...
```{r violinsLineGradient, echo=FALSE, fig.width=8, fig.height=8, cache=!full_refit, fig.cap="", fig.align='center'}
ggplot() +
...
```{r violinsRectGradient, echo=FALSE, fig.width=8, fig.height=8, cache=!full_refit, fig.cap="", fig.align='center'}
ggplot() +
...
```{r violinPolygonGradient, echo=FALSE, fig.width=8, fig.height=8, cache=!full_refit, fig.cap="", fig.align='center'}
...
```{r violinPolygonGradientQuartiles, echo=FALSE, fig.width=8, fig.height=8, cache=!full_refit, fig.cap="", fig.align='center'}
p <- ggplot() + geom_violin(data = dat,aes(x = factor(formula),y = y, fill = method))
p_build <- ggplot2::ggplot_build(p)$data[[1]] 
