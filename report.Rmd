...
b) We perform 10000 different train test splits and do the regression once each (full permutative resampling). We still calculate the median of the color difference between predicted and correct test colors.
